...
var Character = function (_React$Component) {
    ...
    _createClass(Character, [{
        key: 'fetchCharacter',
        value: function fetchCharacter(e) {
            var _this2 = this;

            e.preventDefault();
            fetch('http://localhost:8000/character_builder/api/characters/' + this.state.items.id).then(function (result) {
...
ReactDOM.render(React.createElement(Character, window.props), window.react_mount);
