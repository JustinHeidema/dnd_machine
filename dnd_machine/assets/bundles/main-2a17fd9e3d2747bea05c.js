                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            null,
                            'Race: ',
                            this.state.items.race_name
                        ),
                        React.createElement(
                            'p',
                            null,
                            'Strength Modifier: ',
                            this.state.items.strength_modifier
                        ),
                        React.createElement(
                            'p',
                            null,
                            'Dexterity Modifier: ',
                            this.state.items.dexterity_modifier
                        ),
                        React.createElement(
                            'p',
                            null,
                            'Constitution Modifier: ',
                            this.state.items.constitution_modifier
                        ),
                        React.createElement(
                            'p',
                            null,
                            'Intelligence Modifier: ',
                            this.state.items.intelligence_modifier
                        ),
                        React.createElement(
                            'p',
                            null,
                            'Wisdom Modifier: ',
                            this.state.items.wisdom_modifier
                        ),
                        React.createElement(
                            'h3',
                            null,
                        ...
                        this.state.items.languages.map(function (language) {
                            return React.createElement(
                                'p',
                        ...
                        this.state.items.race_traits.map(function (race_trait) {
                            return React.createElement(
                                'div',
